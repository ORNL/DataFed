...
int main( int a_argc, char ** a_argv )
{
    try
    {
        ...
        opts.add_options()
            ...
            ("task-purge-age",po::value<size_t>( &config.task_purge_age ),"Task purge age (seconds)")
            ("task-purge-per",po::value<size_t>( &config.task_purge_per ),"Task purge period (seconds)")
