...
class ClientWorker : public nlohmann::json_schema::basic_error_handler {
 ...
 private:
  ...
  template <typename RQ, typename RP,
            void (DatabaseAPI::*func)(const RQ &, RP &)>
  std::unique_ptr<IMessage> dbPassThrough(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);

  std::unique_ptr<IMessage> procRepoCreate(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRepoUpdate(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRepoDelete(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procGetAuthStatusRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procVersionRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procAuthenticateByPasswordRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procAuthenticateByTokenRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procGenerateCredentialsRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRevokeCredentialsRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procDataGetRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procDataPutRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procDataCopyRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRecordCreateRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRecordUpdateRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRecordUpdateBatchRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRecordDeleteRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRecordAllocChangeRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRecordOwnerChangeRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procCollectionDeleteRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procProjectDeleteRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procProjectSearchRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRepoAllocationCreateRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRepoAllocationDeleteRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procRepoAuthzRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procUserGetAccessTokenRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procMetadataValidateRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procSchemaCreateRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procSchemaReviseRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  std::unique_ptr<IMessage> procSchemaUpdateRequest(
      const std::string &a_uid, std::unique_ptr<IMessage> &&msg_request);
  ...
  std::string m_validator_err;   ///< String buffer for metadata validation
                                 ///< errors
