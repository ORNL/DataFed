...
public:
    ...
    void recordSearchPublished( const Anon::RecordSearchPublishedRequest & a_request, Anon::ListingReply & a_reply );
    ...
    void topicListTopics( const Anon::TopicListTopicsRequest & a_request, Anon::TopicDataReply & a_reply );
    void topicView( const Anon::TopicViewRequest  & a_request, Anon::TopicDataReply & a_reply );
    void topicSearch( const Anon::TopicSearchRequest & a_request, Anon::TopicDataReply & a_reply );
