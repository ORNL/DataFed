...
describe("the Foxx microservice support module evaluating isUUID.", () => {
    it("should return true if string is a UUID.", () => {
...
describe("the Foxx microservice support module evaluating isUUIDList.", () => {
    it("should return true if string is a UUID List.", () => {
    ...
    it("should return false because one of the provided items is not a uuid", () => {
...
describe("the Foxx microservice support module evaluating parseOtherTokenData.", () => {
    ...
    it("should yield parsed data for a GLOBUS_TRANSFER token when provided a UUID and scopes in order", () => {
        ...
        // act
        const result_object = g_lib.parseOtherTokenData(g_lib.AccessTokenType.GLOBUS_TRANSFER, test_str);
