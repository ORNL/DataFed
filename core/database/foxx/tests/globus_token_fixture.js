...
const globus_token_list = [
    ...
    },
    {
        ...
        collection_id: "globus_coll/" + globus_collection_token_collection,
        key:
    ...
    globus_token_list.map((globus_token_info, idx) => {
        if (!db.globus_token.exists(globus_token_info.key)) {
            const globus_token_data = {
                ...
                access: "globus token access for " + globus_token_info.key,
                refresh: "globus token refresh for " + globus_token_info.key,
            };
