...
class Project {
   ...
   **/
  getAllocations() {
    const allocs = g_db.alloc.byExample({
   ...
   **/ 
   isMember(a_client_id) {
     ...
     if( this.#project.members.includes(a_client_id) ) { return true; } 
     return false;
   }
   ...
   **/ 
   isAdmin(a_client_id) {
     ...
     // Check if the user is a member or admin
     if( this.#project.admins.includes(a_client_id) ) { return true; } 
     return false;
   }

  hasAccess(a_client_id) {
     // Check if the user is a member or admin
     if( this.isMember(a_client_id )) { return true; } 
     if( this.isAdmin(a_client_id )) { return true; } 
     return false;
   }
  /**
