...
DATAFED_NLOHMANN_JSON_VERSION="3.11.3"
...
DATAFED_NVM_VERSION="v0.39.7"
# Git tag
DATAFED_PROTOBUF_VERSION="29.3"
# Dynamic library extension .so.{DATAFED_FULL_PROTOBUF_VERSION}
DATAFED_DYNAMIC_LIBRARY_PROTOBUF_VERSION="29.3.0"
# Full version
DATAFED_FULL_PROTOBUF_VERSION="5.29.0"
...
DATAFED_GCS_SUBMODULE_VERSION="v2.8.0"
