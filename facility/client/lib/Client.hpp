...
public:
    ...
    spRecordDataReply   recordCreate( const std::string & a_title, const char * a_desc = 0, const char * a_alias = 0, const char * a_keyw = 0, const char * a_topic = 0, const char * a_metadata = 0, const char * a_coll_id = 0, const char * a_repo_id = 0, const std::vector<std::string> * a_deps = 0 );
    spRecordDataReply   recordUpdate( const std::string & a_id, const char * a_title = 0, const char * a_desc = 0, const char * a_alias = 0, const char * a_keyw = 0, const char * a_topic = 0, const char * a_metadata = 0, bool a_md_merge = true, const std::vector<std::string> * a_deps_add = 0, const std::vector<std::string> * a_deps_rem = 0, bool g_dep_clear = false );
    ...
    void                collMoveItem( const std::string & a_src_id, const std::string & a_dst_id, const std::string & a_item_id );
