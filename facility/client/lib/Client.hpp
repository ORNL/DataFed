...
public:
  ...
  spRecordDataReply
  recordCreate(const std::string &a_title, const char *a_desc = 0,
               const char *a_alias = 0, const char *a_keyw = 0,
               const char *a_topic = 0, const char *a_metadata = 0,
               const char *a_coll_id = 0, const char *a_repo_id = 0,
               const std::vector<std::string> *a_deps = 0);
