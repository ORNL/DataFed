...
namespace libjson {
    ...
    public:
        ...
        static bool asBool( const std::map<std::string, Value>::const_iterator& iter )
        {
            ...
            EXCEPT_PARAM( 1, "Invalid conversion of " << val.getTypeString() << " value to boolean for key " << iter->first );
        }
        ...
        static std::string& asString( const std::map<std::string, Value>::const_iterator& iter )
        {
            const Value& val = iter->second;
            ...
            EXCEPT_PARAM( 1, "Invalid conversion of " << val.getTypeString() << " value to string for key " << iter->first );
        }

        static const std::string& asStringConst( const std::map<std::string, Value>::const_iterator& iter )
        {
            const Value& val = iter->second;
