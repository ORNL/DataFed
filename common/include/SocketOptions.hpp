...
namespace SDMS {
  ...
  enum class SocketConnectionSecurity {
    SECURE,
    INSECURE
  };
  ...
  struct SocketOptions {
    ...
    SocketDirectionalityType direction_type = SocketDirectionalityType::BIDIRECTIONAL;
    SocketCommunicationType communication_type = SocketCommunicationType::ASYNCHRONOUS;
    SocketConnectionLife connection_life = SocketConnectionLife::PERSISTENT;
    SocketConnectionSecurity connection_security = SocketConnectionSecurity::INSECURE;
