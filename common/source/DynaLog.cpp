...
void Logger::critical(std::string file, std::string func, int line_num,
                      const LogContext &context, const std::string &message) {
  if (static_cast<unsigned int>(m_log_level) >= static_cast<unsigned int>(LogLevel::CRITICAL)) {
