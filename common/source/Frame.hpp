...
namespace SDMS {
  ...
  struct Frame {
    ...
    uint8_t     proto_id = 0;   ///< Protocol ID (defined by Protocol enum in proto file)
    uint8_t     msg_id = 0;     ///< Message ID (defined by alphabetical order of message names in proto file)
