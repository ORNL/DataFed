...
parser.add_argument("start", type=int, help="Collection start index")

parser.add_argument("end", type=int, help="Collection end index (included)")

parser.add_argument(
    "--ctx", metavar="ID", help="Parent / user ID for context (aliases)"
)

parser.add_argument(
    "-p", metavar="COLL", default="test", help="Parent collection id/alias"
)
...
parser.add_argument(
    "--up", metavar="FILE", help="Upload filename from dev server /data/files"
)
...
parser.add_argument("-m", action="store_true", help="Manually authenticate")
