...
_opt_info = {
    ...
    "client_refresh_token": [
        "client",
        "refresh_token",
        "DATAFED_CLIENT_REFRESH_TOKEN",
        _OPT_HIDE,
        ["--client-refresh-token"],
        "Client refresh token issued by the device authorization flow",
    ],
    "core_api_port": [
        "server",
        "core_api_port",
        "DATAFED_CORE_API_PORT",
        _OPT_INT,
        ["--core-api-port"],
        "DataFed core REST API port",
    ],
    "core_api_url": [
        "server",
        "core_api_url",
        "DATAFED_CORE_API_URL",
        0,
        ["--core-api-url"],
        "Base URL for the DataFed core REST API",
    ],
    "device_auth_scope": [
        "client",
        "device_auth_scope",
        "DATAFED_DEVICE_AUTH_SCOPE",
        0,
        ["--device-auth-scope"],
        "OAuth scope request for the device authorization flow",
    ],
