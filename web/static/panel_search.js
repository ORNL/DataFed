...
function SearchPanel(a_frame, a_key, a_parent, a_opts = {}) {
    ...
    this.setQuery = function(query) {
        ...
        $('#srch_text_div').accordion('option', {
            active: query.text ? 0 : false
        });
        ...
        if (query.tags) {
            ...
            suppress_run = false;
            $('#srch_tags_div').accordion('option', {
                active: 0
            });
        } else {
            suppress_run = true;
        ...
        if (query.from || query.to) {
            ...
            $('#srch_date_div').accordion('option', {
                active: 0
            });
        } else {
    ...
    $(".srch-mode", a_frame).selectmenu({
        width: false
    });
    $(".srch-sort", a_frame).selectmenu({
        width: false
    });
