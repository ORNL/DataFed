                            ...
                            p = (function () {
                                    ...
                                    if (e.type === "jshint" || e.type === "jslint")
                                        (t.forEach(function (t) {
                                            ...
                                            if (n === "esversion") {
                                                ...
                                                zt(f.funct) ||
                                                    q("E055", f.tokens.next, "esversion");
                                                return;
                                            }
                                    ...
                                    for (;;) {
                                        ...
                                        if (r.contains(["{", "["], f.tokens.next.id)) {
                                            ...
                                            for (o in s)
                                                ((o = s[o]),
                                                    o.id &&
                                                        (n.push(o.id), p.push([o.id, o.token])));
                                        } else {
                                ...
                                ((rn.exps = !0),
                                    ...
                                    ut("function", function () {
                                        ...
                                        var t = Nt();
                                        return (
                                            Xt({ name: t, type: e ? "generator" : null }),
                                            this
                                        );
                                    }),
                                    st("if", function () {
