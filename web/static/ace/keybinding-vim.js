define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function(e, t, n) {
    ...
    function x(e) {
        e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e, "vim-mode-change", {
            mode: "normal"
        }), e.on("cursorActivity", Gn), tt(e), v.on(e.getInputField(), "paste", M(e))
    }
        ...
        yt = {
            ...
            enterInsertMode: function(e, t, n) {
                ...
                e.setOption("disableInput", !1), t && t.replace ? (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {
                    ...
                    mode: "insert"
                })), nt.macroModeState.isPlaying || (e.on("change", Qn), v.on(e.getInputField(), "keydown", tr)), n.visualMode && $t(e), It(e, s, o)
            },
    ...
    var qn = {
            ...
            substitute: function(e, t) {
                ...
                var n = t.argString,
                    ...
                    o, u, a, f = !1,
                    l = !1;
                if (r.length) i = r[0], s = r[1], i && i[i.length - 1] === "$" && (i = i.slice(0, i.length - 1) + "\\n", s = s ? s + "\n" : "\n"), s !== undefined && (G("pcre") ? s = Tn(s) : s = Sn(s), nt.lastSubstituteReplacePart = s), o = r[2] ? r[2].split(" ") : [];
                else if (n && n.length) {
