    ...
    define("ace/mode/css/csslint", [], function (require, exports, module) {
            ...
            (function () {
                                                ...
                                                : /^([^\(]+)\(/i.test(text)
                                                  ...
                                                  : /^["'][^"']*["']/.test(text)
                                                    ...
                                                    : Colors[text.toLowerCase()]
                                                      ? ((this.type = "color"),
                                                        (temp =
                                                            Colors[text.toLowerCase()].substring(
                                                                1,
                                                            )),
                                                        (this.red = parseInt(
                                                            temp.substring(0, 2),
                ...
                TokenStream.prototype = mix(new TokenStreamBase(), {
                    _getToken: function (e) {
                        ...
                        return (
                            !r && t === null && (r = this.createToken(Tokens.EOF, null, i, s)), r
                        );
                    },
                ...
                var ValidationTypes = {
                    ...
                    simple: {
                        ...
                        "<shape>": function (e) {
                            return (
                                e.type == "function" && (e.name == "rect" || e.name == "inset-rect")
                            );
                        },
                        "<time>": function (e) {
                            return e.type == "time";
        ...
        var util = {
            ...
            getRegExpFlags: function (e) {
                var t = "";
                return (
                    e.global && (t += "g"), e.ignoreCase && (t += "i"), e.multiline && (t += "m"), t
                );
            },
        };
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    ...
                    e.addListener("startfontface", function () {
                        ...
                        e.addListener("endstylesheet", function () {
                            r > 5 &&
                                t.rollupWarn("Too many @font-face declarations (" + r + ").", n);
                        });
                },
            }),
            CSSLint.addRule({
                    ...
                    e.addListener("startrule", function (r) {
                        ...
                        for (f = 0; f < i.length; f++) {
                            ...
                            a === 1
                                ...
                                : a > 1 &&
                                  t.report(a + " IDs in the selector, really?", s.line, s.col, n);
                        }
                    });
                },
            }),
